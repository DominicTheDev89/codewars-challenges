...
// the DNA (string, except for Haskell); you need to return the other complementary side. DNA strand is never empty or there is no 
...
function DNAStrand(dna){
    ...
    for(let i = 0; i < dna.length; i++){
      dna.charAt(i) === 'A' ? answer += 'T' : dna.charAt(i) === 'T' ? answer += 'A' : dna.charAt(i) === 'G' ? answer += 'C' : answer += 'G'
    }
