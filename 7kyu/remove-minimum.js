// The museum of incredible dull things wants to get rid of some exhibitions. Miriam, the interior architect, comes up with a 
// plan to remove the most boring exhibitions. She gives them a rating, and then removes the one with the lowest rating.
...
function removeSmallest(numbers) {
    ...
    if(answer.length === 1 || answer.length === 0){
      ...
      let target = answer.indexOf(min)
      let lost = answer.splice(target, 1)
      return answer;
