...
// If the first character of either of the names given to the function is not a letter from A - Z, you should 
...
function aliasGen(first, last){
  ...
  return firstName[first] && surname[last] ? `${firstName[first]} ${surname[last]}` : "Your name must start with a letter from A - Z."
