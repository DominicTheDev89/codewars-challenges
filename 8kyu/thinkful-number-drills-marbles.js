...
// reaching into the bag, guessing a color, and then pulling one marble out. You get a point if you guessed 
...
// guessBlue() should return the probability of drawing a blue marble, expressed as a float. For example, guessBlue(5, 5, 2, 3) 
// should return 0.6.
...
function guessBlue(blueStart, redStart, bluePulled, redPulled) {
    ...
    return blueLeft / (total - (bluePulled + redPulled));
  }